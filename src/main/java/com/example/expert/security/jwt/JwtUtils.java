package com.example.expert.security.jwt;
...
public class JwtUtils {
    ...
    public ResponseCookie generateJwtCookie(ExpertDetailsImpl expertPrincipal) {
        String jwt = generateTokenFromUsername(expertPrincipal.getUsername());
